...
public class AdminCustomerPageUI {
	...
	public static final String CUSTOMER_ROLE_DROPDOWN_LIST = "xpath=//label[text()='Customer roles']/parent::div/parent::div/following-sibling::div//div[@class='input-group']";
